...
// function card  (props) {        /* In React, props (short for properties) are a fundamental mechanism for passing data between components. */
...
function card  ({username,btnText="value not found when btnText not passed"}) {        /* In React, props (short for properties) are a fundamental mechanism for passing data between components. */
    ...
    <div class="px-6 py-4">
        ...
        <h3 class="mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200">Welcome Back {username}</h3>
        ...
        <form>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <button class="px-6 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                    {btnText }
                    {/* {btnText || "value not found when btnText not passed"} */} 
                </button>
            </div>
        </form>
    </div>
